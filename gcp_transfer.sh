...
gcloud compute scp server/nullbox_server.x86_64 sebjfk@nullbox-server-1:/home/sebjfkcd/nullbox_server
gcloud compute ssh nullbox-server-1 --zone us-central1-a